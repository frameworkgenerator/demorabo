...
const TableWide = ({
  ...
  const openChildItem = () => {
    if (open) {
      console.log(`${entity.type.substring(0, entity.type.length - 1)}Id`, getChildKey)
      sessionStorage.setItem(`${entity.type.substring(0, entity.type.length - 1)}Id`, getChildKey)
      dispatch({
        type: callMethod.child,
      })
      return true
    }
    return false
